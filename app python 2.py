    ...
    def __init__(self, root):
        ...
        def Kilo():
            if var2.get() == 0:
                ...
                if varl1.get() == "Delhi":
                    switch = {"Mumbai": 10, "Kolkata": 8, "Chennai": 6, "Delhi": 0}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Mumbai":
                    switch = {"Mumbai": 0, "Kolkata": 2, "Chennai": 5, "Delhi": 10}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Kolkata":
                    switch = {"Mumbai": 2, "Kolkata": 0, "Chennai": 3, "Delhi": 8}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Chennai":
                    switch = {"Mumbai": 5, "Kolkata": 3, "Chennai": 0, "Delhi": 6}
                    Km.set(switch[varl2.get()])
        ...
        self.cboPickup = ttk.Combobox(TravelFrame, textvariable=varl1, state='readonly', font=('arial', 20, 'bold'),
                                      width=14)
        self.cboPickup['value'] = ('', 'Delhi', 'Chennai', 'Kolkata', 'Mumbai')
        self.cboPickup.current(0)
        ...
        self.cboDrop = ttk.Combobox(TravelFrame, textvariable=varl2, state='readonly', font=('arial', 20, 'bold'),
                                    width=14)
        self.cboDrop['value'] = ('', 'Mumbai', 'Kolkata', 'Delhi', 'Chennai')
        self.cboDrop.current(0)
